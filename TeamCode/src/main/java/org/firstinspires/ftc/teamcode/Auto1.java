...
//
//            //robot.goToAngle(30, 0.1);
//            robot.driveStraightByGyro(robot.DIRECTION_BACKWARD, 8.5, 0.9, true, 20, false);
//            robot.driveStraightByGyro(robot.DIRECTION_BACKWARD, 3, 0.2, true, 20, true);
//            robot.sleep(200, "after gyro wait");
//            robot.sleep(300);
//            robot.servoPosIndex = 0;
//            robot.wobblePinch.setPosition(robot.servoPositions[robot.servoPosIndex]);
...
//            robot.setArmPositionNoWait(-25, 0.1);
//
//            robot.driveStraightByGyro(robot.DIRECTION_FORWARD, 16, 0.8, true, 30, false);
//            //robot.sleep(200, "after gyro wait");
//            robot.goToAnglePID(90);
//            robot.driveStraightByTime(robot.DIRECTION_RIGHT, 500, 0.4);
//            robot.driveStraightByDistance(robot.DIRECTION_LEFT, 1, 0.4);
...
//
//            //robot.goToAngle(30, 0.1);
//            robot.driveStraightByGyro(robot.DIRECTION_BACKWARD, 9.5, 0.9, true, 20, false);
//            robot.driveStraightByGyro(robot.DIRECTION_BACKWARD, 3, 0.2, true, 20, false);
//            robot.sleep(200, "after gyro wait");
//            robot.sleep(300);
//            robot.servoPosIndex = 0;
//            robot.wobblePinch.setPosition(robot.servoPositions[robot.servoPosIndex]);
